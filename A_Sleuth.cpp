...
start
{
    ...
    s.erase(remove(s.begin(), s.end(), '?'), s.end());
    if(s[s.size()-1] == 'a' || s[s.size()-1] == 'A' || s[s.size()-1] == 'e' || s[s.size()-1] == 'E' || s[s.size()-1] == 'i' || s[s.size()-1] == 'I' || s[s.size()-1] == 'o' || s[s.size()-1] == 'O' || s[s.size()-1] == 'u' || s[s.size()-1] == 'U' || s[s.size()-1] == 'y' || s[s.size()-1] == 'Y'){
        yes;line;
